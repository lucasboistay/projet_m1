...
from constants import number_of_simulations, J_values, t_min, t_max, iterations, number_of_pool_processes
from src.graphs import (plot_different_J_graph_magnetization, plot_different_J_graph_energy,
                        ...
                        plot_magnetization_and_energy_normalized,plot_data_from_file)
from src.utils import create_gif, test_different_J_values, renormalise, run_parallel_ising
...
if __name__ == "__main__":
    ...
    run_parallel_ising(number_of_simulations, number_of_pool_processes, temperatures, J=1, J_tab=True)
